...
/**
 * Taxinvoice Service Proxy Class. 
 * Implementation of Popbill Taxinvoice API.
 * @author KimSeongjun
...
public class TaxinvoiceService extends BaseService {
	...
	public float getUnitCost(String CorpNum) throws PopbillException {
		UnitCostResponse response = httpget("/Taxinvoice?cfg=UNITCOST", CorpNum, null, UnitCostResponse.class);
	 ...
	 * @param TOGO 지정값. (TBOX : 연동문서함, SBOX : 매출보관함, PBOX : 매입보관함, WRITE : 매출작성)
	...
	public boolean checkMgtKeyInUse(String CorpNum, MgtKeyType KeyType , String MgtKey) throws PopbillException {
		...
		if(KeyType == null) throw new PopbillException(-99999999,"관리번호형태가 입력되지 않았습니다.");
		if(MgtKey == null || MgtKey.isEmpty()) throw new PopbillException(-99999999,"관리번호가 입력되지 않았습니다.");
	 ...
	 * 세금계산서 1건 임시저장.
	 * @param CorpNum 연동회원 사업자번호
	 * @param taxinvoice 세금계산서 정보.(see com.popbill.api.taxinvoice.Taxinvoice)
	 * @return Response 응답.
	 * @throws PopbillException 
	 */
	 ...
	 * @param taxinvoice 세금계산서 정보. (see com.popbill.api.taxinvoice.Taxinvoice)
	 * @param UserID 회원아이디
	 * @param writeSpecification 거래명세서 동시작성여부. 기본값 : false
	 * @return Response 응답.
	 * @throws PopbillException 
	 */
	 ...
	 * @throws PopbillException 
	 */
	public Response issue(String CorpNum, MgtKeyType KeyType, String MgtKey, String Memo) throws PopbillException
	{
	 ...
	 * @throws PopbillException 
	 */
	public Response issue(String CorpNum, MgtKeyType KeyType, String MgtKey, String Memo, String UserID) throws PopbillException
	{
	 ...
	 * @param MgtKey 연동관리번호
	 * @param Memo 처리 메모
	 * @param ForceIssue 지연발행시 강재발행.
	 * @param UserID 회원 아이디
	 * @return Response 응답.
	 * @throws PopbillException 
	 */
	public Response issue(String CorpNum, MgtKeyType KeyType, String MgtKey, String Memo, boolean ForceIssue, String UserID) throws PopbillException
	{
	 ...
	 * @param MgtKey 연동관리번호
	 * @param Memo 처리 메모
	 * @param EmailSubject 발행시 전달 이메일의 제목설정.
	 * @param ForceIssue 지연발행시 강재발행.
	 * @param UserID 회원 아이디
	 * @return Response 응답.
	 * @throws PopbillException 
	 */
	public Response issue(String CorpNum, MgtKeyType KeyType, String MgtKey, String Memo, String EmailSubject, boolean ForceIssue, String UserID) throws PopbillException
	{
		if(KeyType == null) throw new PopbillException(-99999999,"관리번호형태가 입력되지 않았습니다.");
		if(MgtKey == null || MgtKey.isEmpty()) throw new PopbillException(-99999999,"관리번호가 입력되지 않았습니다.");
		...
		return httppost("/Taxinvoice/" + KeyType.name() + "/" + MgtKey,CorpNum,PostData,UserID,"ISSUE",Response.class); 
	}
	 ...
	 * @param Contents 문자메시지 내용
	 * @return Response 응답 
	 * @throws PopbillException 
	 */
	public Response sendSMS(String CorpNum, MgtKeyType KeyType, String MgtKey,String Sender, String Receiver, String Contents) throws PopbillException
	{
	 ...
	 * @throws PopbillException 
	 */
	public Response sendSMS(String CorpNum, MgtKeyType KeyType, String MgtKey,String Sender, String Receiver, String Contents, String UserID) throws PopbillException
	{
		if(KeyType == null) throw new PopbillException(-99999999,"관리번호형태가 입력되지 않았습니다.");
		if(MgtKey == null || MgtKey.isEmpty()) throw new PopbillException(-99999999,"관리번호가 입력되지 않았습니다.");
	 ...
	 * @throws PopbillException 
	 */
	public Response sendFAX(String CorpNum, MgtKeyType KeyType, String MgtKey, String Sender, String Receiver, String UserID) throws PopbillException
	{
		if(KeyType == null) throw new PopbillException(-99999999,"관리번호형태가 입력되지 않았습니다.");
		if(MgtKey == null || MgtKey.isEmpty()) throw new PopbillException(-99999999,"관리번호가 입력되지 않았습니다.");
	...
	{
		if(KeyType == null) throw new PopbillException(-99999999,"관리번호형태가 입력되지 않았습니다.");
		if(MgtKeyList == null || MgtKeyList.length == 0) throw new PopbillException(-99999999,"관리번호 목록이 입력되지 않았습니다.");
	 ...
	 * @param KeyType 연동관리번호 종류
	 * @param MgtKey 연동관리번호
	 * @param DisplayName 파일 표시명(ex. "통장사본.jpg")
	 * @param FileData 파일 스트림.
	 * @return Response 응답.
	 * @throws PopbillException 
	 */
	...
	public Response attachFile(String CorpNum, MgtKeyType KeyType , String MgtKey , String DisplayName, InputStream FileData , String UserID) throws PopbillException
	{
		if(KeyType == null) throw new PopbillException(-99999999,"관리번호형태가 입력되지 않았습니다.");
		if(MgtKey == null || MgtKey.isEmpty()) throw new PopbillException(-99999999,"관리번호가 입력되지 않았습니다.");
		if(DisplayName == null || DisplayName.isEmpty()) throw new PopbillException(-99999999,"파일 표시명이 입력되지 않았습니다.");
		if(FileData == null) throw new PopbillException(-99999999,"파일 스트림이 입력되지 않았습니다.");
	 ...
	 * @param KeyType 연동관리번호 종류
	 * @param MgtKey 연동관리번호
	 * @param FileID 파일아이디. (AttachedFile.getAttachedFile() 로 확인된 문자열)
	 * @return Response 응답.
	 * @throws PopbillException 
	 */
	...
	public Response deleteFile(String CorpNum, MgtKeyType KeyType, String MgtKey,String FileID, String UserID) throws PopbillException 
	{
		if(KeyType == null) throw new PopbillException(-99999999,"관리번호형태가 입력되지 않았습니다.");
		if(MgtKey == null || MgtKey.isEmpty()) throw new PopbillException(-99999999,"관리번호가 입력되지 않았습니다.");
		if(FileID == null || FileID.isEmpty()) throw new PopbillException(-99999999,"파일아이디가 입력되지 않았습니다.");
	...
	protected class MemoRequest {
		public MemoRequest(String memo) {this.memo = memo;}
		public String memo;
	}
