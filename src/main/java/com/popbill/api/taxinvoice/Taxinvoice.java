...
public class Taxinvoice implements Serializable {
	...
	/**
	 * 공급자 사업자번호 설정 
	 * @param invoicerCorpNum 공급자 사업자번호
	 */
	...
	/**
	 * 공급자 연동관리번호 설정 
	 * @param invoicerMgtKey 공급자 연동관리번호
	 */
	...
	/**
	 * 공급자 종사업장 식별번호 설정
	 * @param invoicerTaxRegID 공급자 종사업장 식별번호
	 */
	...
	/**
	 * 공급자 대표자성명 설정
	 * @param invoicerCEOName 공급자 대표자 성명
	 */
	...
	/**
	 * 공급자 담당자 성명 설정 
	 * @param invoicerContactName 공급자 담당자 성명
	 */
	...
	/**
	 * 공급자 부서명 설정
	 * @param invoicerDeptName 공급자 부서명
	 */
	...
	/**
	 * 공급자 발행시 문자전송여부 설정
	 * @param invoicerSMSSendYN 공급자 발행시 문자전송여부
	 */
	...
	/**
	 * 공급받는자 사업자번호 설정
	 * @param invoiceeCorpNum 공급받는자 사업자번호
	 */
	...
	/**
	 * 공급받는자 연동관리번호 설정
	 * @param invoiceeMgtKey 공급받는자 연동관리번호
	 */
	...
	/**
	 * 공급받는자 종사업장 식별번호 설정
	 * @param invoiceeTaxRegID 공급받는자 종사업장 식별번호
	 */
	...
	/**
	 * 공급받는자 상호 설정
	 * @param invoiceeCorpName 공급받는자 상호
	 */
	...
	/**
	 * 공급받는자 대표자 성명 설정
	 * @param invoiceeCEOName 공급받는자 대표자 성명
	 */
	...
	/**
	 * 공급받는자 업태 설정.
	 * @param invoiceeBizType 공급받는자 업태
	 */
	...
	/**
	 * 공급받는자 업종 설정
	 * @param invoiceeBizClass 공급받는자 업종
	 */
	...
	/**
	 * 공급받는자 담당자1 성명 설정
	 * @param invoiceeContactName1 공급받는자 담당자1 성명
	 */
	...
	/**
	 * 공급받는자 담당자1 부서 설정
	 * @param invoiceeDeptName1 공급받는자 담당자1 부서
	 */
	...
	/**
	 * 공급받는자 담당자1 연락처 설정
	 * @param invoiceeTEL1 공급받는자 담당자1 연락처
	 */
	...
	/**
	 * 공급받는자 담당자1 휴대전화 설정
	 * @param invoiceeHP1 공급받는자 담당자1 휴대전화
	 */
	...
	/**
	 * 공급받는자 담당자1 이메일주소 설정 
	 * @param invoiceeEmail1 공급받는자 담당자1 이메일 주소
	 */
	...
	/**
	 * 공급받는자 담당자2 성명 설정
	 * @param invoiceeContactName2 공급받는자 담당자2 성명
	 */
	...
	/**
	 * 공급받는자 담당자2 부서 설정
	 * @param invoiceeDeptName2 공급받는자 담당자2 부서
	 */
	...
	/**
	 * 공급받는자 담당자2 연락처 설정
	 * @param invoiceeTEL2 공급받는자 담당자2 연락처 
	 */
	...
	/**
	 * 공급받는자 담당자2 휴대전화 설정
	 * @param invoiceeHP2 공급받는자 담당자2 휴대전화 
	 */
	...
	/**
	 * 공급받는자 담당자2 이메일주소 설정 
	 * @param invoiceeEmail2 공급받는자 담당자2 이메일주소 
	 */
	 ...
	 * @param invoiceeSMSSendYN 공급받는자 역발행요청시 문자전송여부 
	 */
	...
	/**
	 * 수탁자 사업자번호 설정
	 * @param trusteeCorpNum 수탁자 사업자번호 
	 */
	...
	/**
	 * 수탁자 연동관리번호 설정
	 * @param trusteeMgtKey 수탁자 연동관리번호 
	 */
	...
	/**
	 * 수탁자 종사업장 식별번호 설정 
	 * @param trusteeTaxRegID 수탁자 종사업장 식별번호 설정
	 */
	...
	/**
	 * 수탁자 대표자 성명 설정
	 * @param trusteeCEOName 수탁자 대표자 성명 
	 */
	...
	/**
	 * 수탁자 업종 설정
	 * @param trusteeBizClass 수탁자 업종 설정
	 */
	...
	/**
	 * 수탁자 담당자 성명 설정 
	 * @param trusteeContactName 수탁자 담당자 성명
	 */
	...
	/**
	 * 수탁자 담당자 부서명 설정
	 * @param trusteeDeptName 수탁자 담당자 부서명
	 */
	...
	/**
	 * 수탁자 담당자 이메일주소 설정 
	 * @param trusteeEmail 수탁자 담당자 이메일주소 
	 */
	...
	/**
	 * 수탁자 발행시 문자전송여부 설정
	 * @param trusteeSMSSendYN 수탁자 발행시 문자전송여부
	 */
	...
	/**
	 * 사업자등록증 이미지 첨부여부 설정
	 * @param businessLicenseYN 사업자등록증 이미지 첨부여부
	 */
	...
	/**
	 * 통장사본 이미지 첨부여부 설정 
	 * @param bankBookYN 통장사본 이미지 첨부여부
	 */
	 ...
	 * @param originalTaxinvoiceKey 원본세금계산서 팝빌 관리번호
	 */
