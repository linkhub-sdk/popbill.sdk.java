...
public class CloseDownServiceImp extends BaseServiceImp implements CloseDownService {
	...
	public float getUnitCost(String CorpNum) throws PopbillException {
		UnitCostResponse response = httpget("/CloseDown/UnitCost",
	...
	public CorpState CheckCorpNum(String MemberCorpNum, String CheckCorpNum)
		...
		return httpget("/CloseDown?CN=" + CheckCorpNum,
				MemberCorpNum, null, CorpState.class);
	}
	 ...
	 */
	@Override
	public CorpState[] CheckCorpNum(String MemberCorpNum, String[] CorpNumList)
			throws PopbillException {
